...
- [Data Set](#-data-set)
  - [Kaggle Data Set](#kaggle-data-set)
  - [Elite Data Set](#elite-data-set)
...
- [Model Evaluation & Analysis](#-model-evaluation--analysis)
  - [Basic Prediction](#basic-prediction--predicting-the-game-winner-based-basic-information-of-the-game)
  - [Predicting the Winner and Victory Status](#predicting-the-winner-and-the-victory-status-using-the-opening-feature)
  - [Predicting the Winner with Early Moves](#predicting-the-winner-only-with-the-early-moves-without-information-about-the-players)
  - [Predicting the Opening](#predicting-the-opening-played-by-a-player)
  - [Extra Study: LLM and Chess](#extra-study--large-language-models-and-chess)
...
To better understand the application of AI to our dataset, we initially used a simple Machine Learning model to predict the winner of a game. 
Using the Kaggle dataset, we employed a Random Forest model to predict the winner (black, white, or draw) based on the players' rankings and the game's length in terms of turns.
The model achieved an F1 score of 68% for accuracy. 
However, it struggled to predict draw results, with an F1 score of only 3% for draws.
